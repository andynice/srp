...
def remove_stopwords(words, language):
    ...
    print(f"len(stop_words_{language}):{len(stop_words)}")
    print(f"stop_words_{language}: {stop_words}")
...
def process(filename, language):
    ...
    for row in data:
        ...
        words_wo_stopwords = remove_stopwords(words, language)
        print(f"words({len(words_wo_stopwords)}): {words_wo_stopwords}")
        results.append(words_wo_stopwords)
...
language = "english"
en_words_wo_stopwords = process(filename_en, language)


## German
filename_de = "test_file_de_small.csv"
language = "german"
en_words_wo_stopwords = process(filename_de, language)
